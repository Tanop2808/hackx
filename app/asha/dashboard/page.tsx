...
export default function ASHADashboardPage() {
  ...
  const ashaPhone = typeof window !== "undefined" ? (localStorage.getItem("ashaPhone") || "9876500001") : "9876500001";
  ...
  useEffect(() => { fetchPatients(); fetchVisits(); }, [fetchPatients, fetchVisits]);
